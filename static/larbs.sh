...
dotfilesrepo="https://github.com/aj10k/voidrice.git"
progsfile="https://raw.githubusercontent.com/aj10k/LARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
echo "%wheel ALL=(ALL:ALL) NO PASSWD: ALL" >/etc/sudoers.d/00-larbs-wheel-can-sudo
